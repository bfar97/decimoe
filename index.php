...
<html xmlns:fb="http://ogp.me/ns/fb#" lang="en">
  ...
  <body>
    ...
    <header class="clearfix">
      ...
      <div>
        <h1>És lindo/a, <strong><?php echo he(idx($basic, 'name')); ?></strong></h1>
        <p class="tagline">
          Esta é a aplicação do
...
*/
$calendario = array(
    0 => array_fill(0, $pri_dia_sem, NULL)
);
...
$calendario[$semana] += array_fill($dia_semana, 6, NULL);
